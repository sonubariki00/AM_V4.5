    ...
    def print_logs(self):
        try:
            ...
            for log in logs:
                ...
                log_text.insert(tk.END, f"Level: {log['level']}\n")
                log_text.insert(tk.END, f"Message: {log['message']}\n")
                if log.get('user'):
                    log_text.insert(tk.END, f"User: {log['user']}\n")
                if log.get('details'):
                    log_text.insert(tk.END, f"Details: {log['details']}\n")
